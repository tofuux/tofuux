...
<img width="600" src="https://quickchart.io/chart?c={type:'radar',data:{labels:['Machine Learning','Deep Learning','Python/Data','Web Dev','DSA/OOP','Backend'],datasets:[{data:[88,82,90,65,78,70],backgroundColor:'rgba(0,255,255,0.25)',borderColor:'rgb(0,255,255)'}]},options:{plugins:{legend:{display:false}},scales:{r:{ticks:{display:false}}}}}">
